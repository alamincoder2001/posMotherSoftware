...
<body style="background:none;">
  <table width="800px">
    ...
    <tr>
      ...
      ?>
      <td colspan="2" style="height:;" align="center">
        <h1 style="font-size: 20px; font-weight: bold; text-decoration: underline;">Supplier Transaction From <b style="color: #6F085C;"><?php echo $Purchase_startdate ?></b> To <b style="color: #6F085C;"><?php echo $Purchase_enddate ?></b></h1>
      </td>
    </tr>
    <tr>
      <td style=" font-size: 14px; font-weight: bold;" colspan="1">
        Supplier ID : <?php if (isset($recordss->Supplier_Code)) : echo $recordss->Supplier_Code;
                      endif; ?>
      </td>
      <td style="text-align: right; font-size: 14px; font-weight: bold;">
        Address : <?php if (isset($recordss->Supplier_Address)) : echo $recordss->Supplier_Address;
                  endif; ?>
      </td>
    </tr>
    <tr>
      <td style=" font-size: 14px; font-weight: bold;" colspan="1">
        Supplier Name : <?php if (isset($recordss->Supplier_Name)) : echo $recordss->Supplier_Name;
                        endif; ?>
      </td>
      <td style="text-align: right; font-size: 14px; font-weight: bold;">
        Contact : <?php if (isset($recordss->Supplier_Mobile)) : echo $recordss->Supplier_Mobile;
                  endif; ?>
      </td>
    </tr>
    <!-- <tr>
